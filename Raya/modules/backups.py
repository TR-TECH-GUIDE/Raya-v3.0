...
# from Raya.modules.sql import warns_sql as warnssql
import Raya.modules.sql.blacklist_sql as blacklistsql

# from Raya.modules.sql import cust_filters_sql as filtersql
# import Raya.modules.sql.welcome_sql as welcsql
import Raya.modules.sql.locks_sql as locksql
import Raya.modules.sql.notes_sql as sql

# from Raya.modules.rules import get_rules
import Raya.modules.sql.rules_sql as rulessql
from Raya import JOIN_LOGGER, LOGGER, OWNER_ID, dispatcher
from Raya.__main__ import DATA_IMPORT
from Raya.modules.connection import connected
from Raya.modules.helper_funcs.alternate import typing_action
from Raya.modules.helper_funcs.chat_status import user_admin
from Raya.modules.sql import disable_sql as disabledsql
...
def export_data(update, context):
    ...
    f = open("Raya{}.backup".format(chat_id), "w")
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("Raya{}.backup".format(chat_id), "rb"),
        caption="*Successfully Exported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `Raya-Backup` was specially made for notes.".format(
            chat.title, chat_id, tgl
        ),
        timeout=360,
    ...
    os.remove("Raya{}.backup".format(chat_id))  # Cleaning file
