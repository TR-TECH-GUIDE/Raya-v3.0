...
import Raya.modules.sql.userinfo_sql as sql
from Raya import (
    DEMONS,
    DEV_USERS,
    DRAGONS,
...
from Raya import telethn as SaitamaTelethonClient
from Raya.__main__ import STATS, TOKEN, USER_INFO
from Raya.modules.disable import DisableAbleCommandHandler
from Raya.modules.helper_funcs.chat_status import sudo_plus
from Raya.modules.helper_funcs.extraction import extract_user
from Raya.modules.sql.afk_sql import check_afk_status, is_afk
from Raya.modules.sql.global_bans_sql import is_user_gbanned
from Raya.modules.sql.users_sql import get_user_num_chats
...
def info(update: Update, context: CallbackContext):
    ...
    if disaster_level_present:
        text += ' [<a href="https://t.me/trtrechguide">?</a>]'.format(bot.username)
...
def set_about_bio(update: Update, context: CallbackContext):
    ...
    if message.reply_to_message:
        ...
        if user_id in [1202064253, 996634013] and sender_id not in DEV_USERS:
...
*What is that health thingy?*
 Come and see [HP System explained](https://t.me/trtrechguide)
"""
