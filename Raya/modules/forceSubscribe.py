#    Copyright (C) 2020-2021 by @trtechguide
#    This program is a part of trforcesubscriberbot TG bot project
#
...
from Raya import pbot
from Raya.modules.sql import forceSubscribe_sql as sql
