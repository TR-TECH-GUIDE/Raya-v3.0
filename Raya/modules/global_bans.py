...
import Raya.modules.sql.global_bans_sql as sql
from Raya import (
    DEMONS,
    DEV_USERS,
    DRAGONS,
...
from Raya.modules.helper_funcs.misc import send_to_list
from Raya.modules.sql.users_sql import get_user_com_chats
